...
import de.thm.mni.hybridcomputing.hssa.util.Transformer.WithContext.BlockTransformer

object EntryExitPairExpressionNormalization extends BlockTransformer {
    private def find_unique_name(context: BindingTree, prefix: String = "x"): Identifier = {
    ...
    private case class ExpandResult(new_expression: Expression, expansion_assignment: Option[Syntax.Assignment])
