...
import de.thm.mni.hybridcomputing.hssa.plugin.{Arithmetic, Basic, Information, Testing, Arrays}
...
object Language {
    val Canon = Language(Seq(Basic, Arithmetic, Information, Testing, Arrays), Semantics(true))
