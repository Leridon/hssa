...
object Translatable {
    case class TypedVariable(override val name: VariableIdentifier, override val owner: Scope, override val definition: SourcePosition, typ: Type) extends Variable(name, owner, definition)
    ...
    case class New(typ: Typing.ObjectType, name: VariableReference) extends WellformedStatement
    case class Delete(typ: Typing.ObjectType, name: VariableReference) extends WellformedStatement
    case class Copy(typ: Typing.ObjectType, from: VariableReference, to: VariableReference) extends WellformedStatement
    case class Uncopy(typ: Typing.ObjectType, from: VariableReference, to: VariableReference) extends WellformedStatement
